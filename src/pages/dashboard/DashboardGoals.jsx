  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={() => navigate('/onboarding')} className="px-3 py-2 bg-gray-50 rounded-md text-sm">Edit Goals</button>
      </div>

      {primary.length === 0 && custom.length === 0 ? (
        <div className="p-6 bg-white border border-gray-200 rounded-lg">
          <p className="text-gray-600 mb-4">You have not set any goals yet.</p>
